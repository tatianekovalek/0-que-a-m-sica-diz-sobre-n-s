...
function mostraResultado() {
    ...
    perguntaAtual={
        ...
        {
            texto: "Sim.",
            afirmacao: "Que bom!Fico feliz em saber disso"
        },
        {
            texto: "Não.",
            afirmacao: "Sinto muito!A sua opinião é importante!"
        },
     ]
},
...
mostraPergunta(); 
    ...
    //Adicionar o botão ao elemento de alternativas

    caixaAlternativas.appendChild(proximoButton);
